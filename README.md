# 币安Alpha全自动交易机器人
## 新功能
- **空投自动卖出**：BSC 空投到账后自动整点市价卖出，软件开着就生效，不用守在电脑前，也不用先启动交易
- **Cookie 自动刷新**：启动交易时自动给会话续期，告别隔三差五重新复制 cURL
- **一键验证 Cookie**：设置页点一下就知道账号还有没有效，不用等交易报错才发现
- 低磨损交易赛，实测万2磨损
...
## 会封号吗？
不会，目前已经超过30人持续运行超过8个月，证明使用AlphaBot不会被封号。  
